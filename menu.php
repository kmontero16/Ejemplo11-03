...
<a id="subsolicitud" class="list-group-item submenu" href="<?=URLBASE;?>contenido/vacaciones.php" ><i class="fa fa-sun-o fa-2x"></i> Vacaciones</a>
<a id="subsolicitud-2" class="list-group-item submenu" href="<?=URLBASE;?>contenido/verVacaciones.php" ><i class="fa fa-sun-o fa-2x"></i> Ver Vacaciones</a>
